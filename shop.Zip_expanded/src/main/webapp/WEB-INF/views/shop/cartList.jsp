		...
		<ul class="list-group list-group-flush">
			<li class="list-group-item">
				<div class="allCheck">
					...
					<div class="">
						<button type="button" 
						class="selectDelete_btn btn-outline-danger btn-lg"
						>선택삭제</button>
					</div>
				</div>
			</li>
			...
			<c:forEach items="${cartList}" var="cartList">
				...
				<!-- 반복할 때마다 sum에 상품가격(gdsPrice) * 상품개수(cartStock)만큼을 더함 -->
				...
				<form role="form" method="post" autocomplete="off">
					...
					<div class="">
						...
						<div id="layer" style="display: none; position:fixed; overflow:hidden; z-index:1; -webkit-overflow-scrolling:touch;">
							...
							id="btnCloseLayer"
							style="cursor: pointer; position: absolute; right: -3px; z-index:1"
						...
						<div class="">
							<div class="my-5 d-flex justify-content-end">
								<div class="btn-group">
									...
									<a href="#" class="cancel_btn btn btn-outline-danger">취소</a>
								</div>
							</div>
						</div>
					</div>
