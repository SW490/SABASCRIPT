      ...
      <div class="collapse navbar-collapse" id="mynavbar">
         <ul class="navbar-nav me-auto align-items-center">
            <c:if test="${member == null}"><!-- 미로그인 -->
               ...
               <li class="nav-item">
                  <a class="text-decoration-none link-coralred" href="${contextPath}/shop/list?c=101&l=2">Contents</a>
               </li>
            </c:if>
            <!-- 로그인을 했을때 -->
            <c:if test="${member != null }">
               ...
               <li class="nav-item fw-bold mx-2">
                  <a class="nav-link fw-bold link-coralred" href="${contextPath}/shop/list?c=1&l=2">Contents</a>
               </li>
               <li class="nav-item fw-bold mx-2">
                  <a class="nav-link link-coralred" href="${contextPath}/shop/cartList">Scrap</a>
               </li>
